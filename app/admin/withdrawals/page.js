...
export default function AdminWithdrawals() {
  ...
  const handleApprove = async (withdrawal) => {
    if (
      !confirm(
        `Approve withdrawal of ${withdrawal.currency} ${withdrawal.amount} for ${withdrawal.profiles.full_name}?`,
      )
    ) {
      return;
    }
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-purple-800/50">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-emerald-400">
                      ...
                      {Number(
                        selectedWithdrawal.profiles?.balance || 0,
                      ).toFixed(2)}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-orange-400">
                        {selectedWithdrawal.crypto_network}
                      </p>
                    </div>
                    <div>
                    ...
                    <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                      <p className="text-xs text-amber-400 flex items-start gap-2">
                        ...
                        Verify the wallet address before approving. Transactions
                        cannot be reversed.
                      </p>
                    </div>
                  </div>
              ...
              {selectedWithdrawal.status === "pending" &&
                Number(selectedWithdrawal.profiles?.balance) <
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-300">
                          User's current balance ({selectedWithdrawal.currency}{" "}
                          {Number(
                            selectedWithdrawal.profiles?.balance || 0,
                          ).toFixed(2)}
