...
export default function ResetPassword() {
  ...
  return (
    <>
      <Header isDarkMode={isDarkMode} />
      <div
        className={`min-h-screen flex items-center justify-center py-12 transition-colors duration-300 ${
          isDarkMode
            ? "bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950"
            : "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50"
        }`}
      >
        ...
        >
          ...
          {success && (
            <div
              className={`px-4 py-3 rounded-lg mb-6 flex items-start gap-3 ${
                isDarkMode
