    ...
    >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              {success && (
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      className={`text-sm ${
                        isDarkMode ? "text-emerald-400/80" : "text-green-700"
                      }`}
                    >
            ...
            <div>
              ...
              >
                Visit our headquarters or reach out to any of our regional
                offices worldwide.
              </p>
      ...
      <section
        className={`py-20 px-6 ${
          isDarkMode ? "bg-slate-900/40" : "bg-indigo-50/50"
        }`}
      >
        <div className="max-w-7xl mx-auto">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Create your free account today and join thousands of successful
            traders
          </p>
          <a
            href="/signup"
