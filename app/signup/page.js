...
export default function SignUp() {
    ...
    const adjustFixedElements = () => {
      ...
      if (topValue > 0) {
        ...
        fixedElements.forEach((el) => {
          ...
          if (currentTop < 100) {
            // Only adjust elements near the top
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen flex items-center justify-center py-24 px-6 transition-colors duration-300 ${
          isDarkMode
      ...
      >
        ...
        <div
          className={`p-8 rounded-2xl shadow-2xl w-full max-w-md transition-all duration-300 mt-16 ${
            isDarkMode
        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div
                className={`w-16 h-16 rounded-lg flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform ${
                  isDarkMode
                    ? "bg-gradient-to-br from-emerald-600 to-teal-600"
                    : "bg-gradient-to-br from-blue-600 to-indigo-600"
                }`}
