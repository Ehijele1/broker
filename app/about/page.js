...
function StatCard({ value, label, isDarkMode }) {
  return (
    ...
    >
      <h3
        className={`text-4xl font-extrabold mb-2 ${isDarkMode ? "text-emerald-400" : "text-indigo-600"}`}
      >
        {value}
      </h3>
      <p
  ...
  return (
    <div className="flex gap-6">
      <div className="flex flex-col items-center">
        ...
        <div
          className={`w-0.5 flex-1 mt-2 ${isDarkMode ? "bg-slate-700" : "bg-indigo-200"}`}
        ></div>
      </div>
      <div className="pb-8">
        <h3 className="text-xl font-bold mb-2">{title}</h3>
    ...
    >
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            We're on a mission to democratize trading and make financial markets
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Founded in 2015, SecureProTrading was born from a simple vision:
                to create a trading platform that combines cutting-edge
                technology with user-friendly design, making professional
                trading accessible to everyone.
              </p>
              <p
                className={`mb-4 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                Our founders, experienced traders and technology experts,
                recognized the gap in the market for a platform that truly
                prioritizes user success. They set out to build not just another
                trading platform, but a comprehensive ecosystem that educates,
                empowers, and supports traders at every level.
              </p>
              <p className={isDarkMode ? "text-slate-400" : "text-gray-600"}>
                Today, we serve over 50,000 traders worldwide, processing
                billions in trading volume annually, and we're just getting
                started.
              </p>
            </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              <Target
                className={`mb-4 ${isDarkMode ? "text-emerald-400" : "text-indigo-600"}`}
                size={40}
              />
              <h3 className="text-2xl font-bold mb-4">Our Mission</h3>
              <p className={isDarkMode ? "text-slate-400" : "text-gray-600"}>
                To empower individuals worldwide with the tools, knowledge, and
                confidence to achieve financial independence through intelligent
            ...
            >
              ...
              <p className={isDarkMode ? "text-slate-400" : "text-gray-600"}>
                ...
                platform, where technology meets human expertise to create
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Join thousands of traders who trust SecureProTrading for their
            financial success
          </p>
