...
export default function DepositPage() {
  ...
  const handleDeposit = async (e) => {
    ...
    if (depositAmount < selectedPaymentMethod.minAmount) {
      alert(
        `Minimum deposit amount is ${profile.currency} ${selectedPaymentMethod.minAmount}`,
      );
      return;
    }
  ...
  const selectedNetworkData = cryptoNetworks.find(
          ...
          <div>
            ...
            >
              ...
              <li className="flex items-start gap-2">
                ...
                />
                <span>
                  Ensure you send funds to the correct address/account
                </span>
              </li>
            </ul>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {paymentMethods.map((method) => (
                ...
                >
                  <div
                    className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${method.color} opacity-10 rounded-full blur-3xl`}
                  ></div>
                  <div className="relative z-10">
                    ...
                    <p
                      className={`text-sm mb-3 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
                    >
                      {method.description}
                    </p>
                    <div
                      className={`space-y-1 text-xs ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
                    >
                  ...
                  {selectedNetwork && selectedNetworkData && (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <code
                          className={`flex-1 text-sm px-3 py-2 rounded border overflow-x-auto ${
                            isDarkMode
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard(selectedNetworkData.address)
                          }
                        ...
                        {selectedNetworkData.qr_code_url && (
                          <button
                            onClick={() =>
                              viewQRCode(selectedNetworkData.qr_code_url)
                            }
                            className={`p-2 rounded transition-colors ${
                              isDarkMode
                      ...
                      {selectedNetworkData.qr_code_url && (
                        ...
                        >
                          ...
                          >
                            ...
                            <span>
                              QR Code available! Click the QR button above to
                      ...
                      >
                        <AlertCircle className="w-4 h-4 flex-shrink-0 mt-0.5" />
                        <span>
                          Send only {selectedNetworkData.name} to this address.
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        Please use your account email or username as the
                        transfer reference for faster processing
                      </span>
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {proofPreview ? (
                    ...
                    >
                      ...
                      <p
                        className={`text-xs mt-1 ${isDarkMode ? "text-slate-500" : "text-gray-500"}`}
                      >
                        PNG, JPG up to 10MB
                      </p>
                      <input
        ...
        <div className="space-y-6">
          ...
          >
            ...
            >
              If you have any questions or issues with your deposit, contact our
              support team.
            </p>
            <button
              type="button"
