        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className={`rounded-2xl p-8 text-center border ${
            ...
            <div className={`rounded-xl p-6 space-y-4 ${
              isDarkMode ? 'bg-slate-900/50' : 'bg-white border border-indigo-200 shadow-sm'
            }`}>
              ...
              <div className="flex items-center justify-between">
                <span className={isDarkMode ? 'text-slate-400' : 'text-gray-600'}>Email Address</span>
              ...
              {user.email_confirmed_at && (
                <div className="flex items-center justify-between">
                  <span className={isDarkMode ? 'text-slate-400' : 'text-gray-600'}>Verified On</span>
                  <span className={`font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              ...
              <div className="flex items-center justify-between">
                <span className={isDarkMode ? 'text-slate-400' : 'text-gray-600'}>Account Name</span>
                <span className={`font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              <div className={`rounded-lg p-4 ${
                isDarkMode ? 'bg-slate-900/30' : 'bg-white border border-indigo-200'
              }`}>
    ...
    <div className={`min-h-screen p-4 lg:p-8 ${
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className={`rounded-2xl p-8 border text-center ${
          ...
          <p className={`mb-2 ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
            Please verify your email address to unlock all features and secure your account.
          </p>
          <p className={`text-sm mb-8 ${isDarkMode ? 'text-slate-500' : 'text-gray-500'}`}>
            We'll send a verification link to <strong className={
              isDarkMode ? 'text-white' : 'text-gray-900'
            }>{user?.email}</strong>
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className={`rounded-xl p-4 ${
              isDarkMode ? 'bg-slate-800/30' : 'bg-indigo-50 border border-indigo-200'
            }`}>
              <CheckCircle className={`w-8 h-8 mx-auto mb-2 ${
                isDarkMode ? 'text-emerald-400' : 'text-emerald-600'
              }`} />
          ...
          <p className={`text-xs mt-4 ${isDarkMode ? 'text-slate-500' : 'text-gray-500'}`}>
          ...
          <div className={`mt-6 pt-6 border-t ${
            ...
            <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
              <strong className={isDarkMode ? 'text-white' : 'text-gray-900'}>Need help?</strong> Contact our support team if you're having trouble verifying your email.
            </p>
          </div>
        </div>
      </div>
