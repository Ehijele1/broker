...
function FeatureCard({ icon: Icon, title, description, isDarkMode }) {
  return (
    <div
      className={`p-6 rounded-xl border transition-all duration-300 hover:-translate-y-2 ${
        isDarkMode
          ? "bg-slate-900/40 border-slate-800 hover:border-emerald-400/50"
          : "bg-white border-indigo-200 shadow-sm hover:shadow-lg hover:border-indigo-400"
      }`}
    >
      <div
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div
          className={`p-3 rounded-lg ${isDarkMode ? "bg-emerald-400/10" : "bg-indigo-50"}`}
        >
          <Icon
            className={isDarkMode ? "text-emerald-400" : "text-indigo-600"}
            size={24}
    ...
    >
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p
            className={`text-xl max-w-3xl mx-auto ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
          >
            From advanced analytics to copy trading, our platform provides all
            the tools and features you need to trade like a professional.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              className={`max-w-2xl mx-auto ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
            >
              Professional-grade tools designed to give you an edge in the
              markets
            </p>
          </div>
      ...
      <section
        className={`py-20 px-6 ${isDarkMode ? "bg-slate-900/40" : "bg-white"}`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Never miss an opportunity. Follow expert traders and
                automatically copy their positions, strategies, and portfolio
                allocations in real-time.
              </p>

              <div className="space-y-4">
                <BenefitItem
                  text="Choose from thousands of verified expert traders"
                  isDarkMode={isDarkMode}
                />
                <BenefitItem
                  text="Set custom risk management parameters"
                  isDarkMode={isDarkMode}
                />
                <BenefitItem
                  text="Copy multiple traders simultaneously"
                  isDarkMode={isDarkMode}
                />
                <BenefitItem
                  text="Stop-loss and take-profit automation"
                  isDarkMode={isDarkMode}
                />
                <BenefitItem
                  text="Detailed performance analytics for each trader"
                  isDarkMode={isDarkMode}
                />
                <BenefitItem
                  text="Start with as little as $100"
                  isDarkMode={isDarkMode}
                />
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              className={`max-w-2xl mx-auto ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
            >
              Your safety is our top priority. We use military-grade encryption
      ...
      {/* PLATFORM ACCESS */}
      <section
        className={`py-20 px-6 ${isDarkMode ? "bg-slate-900/40" : "bg-indigo-50/50"}`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-extrabold mb-4">
            ...
            <p
              className={`max-w-2xl mx-auto ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
            >
              Access your account and trade on any device with our responsive
              platform
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="mb-6 flex justify-center">
                <div
                  className={`p-4 rounded-2xl ${isDarkMode ? "bg-emerald-400/10" : "bg-indigo-50"}`}
                >
                  <Globe
                    className={
                      isDarkMode ? "text-emerald-400" : "text-indigo-600"
              ...
              >
                Full-featured trading platform accessible from any web browser.
            ...
            >
              ...
              <p
                className={`mb-6 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                Trade on-the-go with our native iOS and Android apps. Full
            ...
            >
              ...
              <p
                className={`mb-6 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                Advanced trading interface for Windows and Mac with enhanced
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p
                className={`mb-8 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                Access comprehensive educational resources and get support
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
                    >
                      Free courses, webinars, and tutorials covering everything
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
                    >
                      Get help anytime via live chat, email, or phone. Our
                      expert team is always ready to assist.
                    </p>
                  </div>
                </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Create your free account today and get access to all our premium
            features
          </p>
