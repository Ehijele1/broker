  ...
  return (
    <motion.div
      ...
      className={`p-6 rounded-xl border text-center cursor-pointer transition-all duration-300 ${
        isDarkMode
          ? "bg-slate-800/40 border-slate-700 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/20"
          : "bg-white border-indigo-200 shadow-sm hover:shadow-indigo-200/50 hover:shadow-xl"
      }`}
    >
      <motion.h4
  ...
  return (
    <motion.div
      ...
      className={`p-8 rounded-2xl border transition-all duration-300 ${
        isDarkMode
          ? "bg-slate-900/60 border-slate-800 hover:border-emerald-500/50 hover:shadow-xl"
          : "bg-white border-indigo-200 shadow-sm hover:shadow-md hover:shadow-indigo-200/50"
      }`}
    >
      <motion.div
        className="mb-4"
      ...
      >
        <Icon
          className={isDarkMode ? "text-emerald-400" : "text-indigo-600"}
          size={32}
        />
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6">
        <p
          className={`text-sm font-semibold mb-2 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
        >
          {name}
        </p>
      ...
      <ul className="space-y-3 mb-8">
        {features.map((f, i) => (
          ...
          >
            <CheckCircle
              className={`flex-shrink-0 ${isDarkMode ? "text-emerald-400" : "text-indigo-600"}`}
              size={18}
            />
            <span>{f}</span>
          </motion.li>
    ...
    <motion.div
      ...
      className={`p-6 rounded-xl border ${
        isDarkMode
          ...
          : "bg-white border-indigo-200 shadow-sm hover:shadow-lg"
      }`}
    >
      <motion.div
...
function TestimonialCard({ quote, name, role, isDarkMode, index = 0 }) {
  return (
    ...
    >
      <p
        className={`mb-6 italic ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
      >
        "{quote}"
      </p>
...
function FAQItem({ question, answer, isDarkMode }) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`px-5 pb-5 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
        >
...
export default function LandingPage() {
  ...
  const changeLanguage = (langCode) => {
    ...
    if (langCode === "en") {
      ...
      window.location.href =
        window.location.pathname + "?lang=en&t=" + Date.now();
    } else {
  ...
  return (
    <div
      className={`min-h-screen ${isDarkMode ? "bg-slate-950 text-white" : "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 text-gray-900"}`}
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                <span
                  className={`font-semibold text-sm ${isDarkMode ? "text-emerald-400" : "text-indigo-700"}`}
                >
              ...
              >
                ...
                than 100 assets of the world's leading companies.
              </motion.p>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <h4
                      className={`font-bold text-2xl ${isDarkMode ? "text-emerald-400" : "text-indigo-600"}`}
                    >
                      {stat.value}
                    </h4>
                    <p
      ...
      {/* TRUSTED PARTNERS */}
      <section
        className={`py-12 border-y ${isDarkMode ? "bg-slate-900/40 border-slate-800" : "bg-white border-indigo-100"}`}
      >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                A platform that allows novice traders to copy/mirror
                professional traders' positions. We create all of the materials
                to assist you in growing and progressing to the next level.
              </p>
              <p
                className={`mb-8 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                We're delighted you came across Our Company. Don't pass up this
                chance to hear about what we do and the incredible team that
      ...
      <section id="services" className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div
            className={`absolute inset-0 ${isDarkMode ? "bg-slate-900/40" : "bg-indigo-50/50"}`}
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className={isDarkMode ? "text-slate-400" : "text-gray-600"}>
              We offer world class services - Check out some of our services
              below
            </p>
          </motion.div>
      ...
      <section id="plans" className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1559526324-593bc073d938?q=80&w=2940&auto=format&fit=crop')",
            }}
          />
        </div>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1642790106117-e829e14a795f?q=80&w=2940&auto=format&fit=crop')",
            }}
          />
          <div
            className={`absolute inset-0 ${isDarkMode ? "bg-slate-900/40" : "bg-indigo-50/50"}`}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p
                className={`mb-8 ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                The professionalism of the team and experience have allowed us
                to create a technological and reliable tool for investors!
              </p>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  >
                    <CheckCircle
                      className={`flex-shrink-0 mt-1 ${isDarkMode ? "text-emerald-400" : "text-indigo-600"}`}
                      size={20}
                    />
                    <span>{item}</span>
                  </motion.div>
            ...
            >
              <div
                className={`aspect-square rounded-xl flex items-center justify-center ${
                  isDarkMode
                    ? "bg-gradient-to-br from-emerald-400/20 to-blue-500/20"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                quote:
                  "I was new to trading and didn't know where to start. Copy trading allowed me to follow experienced traders and grow my portfolio effortlessly. In just three months, I've seen consistent profits!",
                name: "John D. Bryan",
                role: "Customer",
              },
              {
                quote:
                  "I've always wanted to trade, but I never had the time or knowledge. Copy trading made it so easy! Now I'm earning profits by following top traders while focusing on my daily job.",
                name: "Murillo Fred",
                role: "Customer",
              },
              {
                quote:
                  "I was skeptical at first, but after carefully selecting top traders, I've been able to grow my investments steadily. The transparency and control over my funds make this a game-changer!",
                name: "Emily R.",
                role: "Customer",
              },
              {
                quote:
                  "What I love about copy trading is the ability to diversify. I follow multiple traders with different strategies, which helps balance my portfolio. Highly recommended!",
                name: "Mike Benard",
                role: "Customer",
              },
              {
                quote:
                  "I used to spend hours analyzing the markets, but with copy trading, I let the experts do the work. My returns have been solid, and I've learned so much just by observing the pros.",
                name: "Memphis Daniel",
                role: "Customer",
              },
              {
                quote:
                  "I love how copy trading lets me learn from experienced traders while making money. Watching their strategies has helped me improve my own trading skills!",
                name: "Samantha K.",
                role: "Customer",
              },
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer:
                  "To deposit funds in your SecureProTrading account, you may choose any of the available methods of payment in your country. Log in to your account, click on 'Deposit', enter the amount you wish to deposit, select the method of payment from the dropdown menu, and copy wallet address if crypto deposit is selected.",
              },
              {
                question: "What is Copy Stop Loss?",
                answer:
                  "Copy Stop Loss (CSL) is an instruction to close a copy if the value of the entire copy drops below a specific dollar amount or ratio. You can use this to protect your investment - to automatically sell the copy investment if its value goes down. CSL is mandatory on every copy. You can set the CSL anywhere between 5% and 95%.",
              },
              {
      ...
      {/* FOOTER */}
      <footer
        className={`py-16 px-6 border-t ${isDarkMode ? "bg-slate-900/60 border-slate-800" : "bg-white border-indigo-100"}`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h3
                className={`font-extrabold text-xl mb-4 ${isDarkMode ? "text-emerald-400" : "text-indigo-600"}`}
              >
                SecureProTrading
              </h3>
              <p
                className={`text-sm ${isDarkMode ? "text-slate-400" : "text-gray-600"}`}
              >
                We help your money grow by putting it to work. Our experts
                ensure not only that your funds are at work, but are put in
                carefully planned and strategically diversified trading and
          ...
          <div
            className={`pt-8 border-t text-center text-sm ${
              isDarkMode
                ...
                : "border-indigo-100 text-gray-600"
            }`}
          >
