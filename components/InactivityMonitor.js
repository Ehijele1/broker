  ...
  const checkSessionExpiry = async () => {
    ...
    if (lastActivity) {
      ...
      if (timeSinceActivity > SESSION_MAX_AGE) {
        console.log('[INACTIVITY] Session expired - last activity was', Math.floor(timeSinceActivity / 1000 / 60 / 60), 'hours ago')
        await handleLogout()
        return false
      }
      ...
      if (timeSinceActivity > INACTIVITY_TIMEOUT) {
        console.log('[INACTIVITY] Session expired due to inactivity - last activity was', Math.floor(timeSinceActivity / 1000 / 60), 'minutes ago')
        await handleLogout()
        return false
      }
    }
