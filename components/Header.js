...
function CryptoTicker({ isDarkMode }) {
  ...
  return (
    <div className={`py-2 overflow-hidden relative ${
      ...
      <div className="crypto-ticker flex gap-8 animate-scroll">
...
export default function Header({ isDarkMode = true }) {
  ...
  return (
    <>
      ...
      {/* Crypto Ticker - positioned right below header */}
      <div className="fixed top-16 left-0 right-0 z-30">
        <CryptoTicker isDarkMode={isDarkMode} />
      </div>
    </>
  )
}